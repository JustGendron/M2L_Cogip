            ...
            <ul class="nav navbar-nav">
                <li class="dropdown" class="active">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="index.php?uc=m2lpratiques&action=Modalitesacces">Modalités d'accès</a></li>

                        <li><a href="index.php?uc=m2lpratiques&action=Services informatiques">Services informatiques</a></li>
