<div class="container" role="main">
    <h4 class="mt-5">Présentation des communications</h4>

    <br/>
    <br/>
    <p class ="lead">
        Accès Affranchissement
    </p>
    <p>
    ...
    <p>
        ...
        ligues.
        <br/>
        * une photocopieuse noir et blanc à 70 pages/minute avec différents dispositifs de
        finition,
        <br/>
